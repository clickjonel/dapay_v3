<script setup>
    ...
    const form = useForm({
        ...
        handledBarangays: props.user.barangays ?? []  // pre-select existing assignments
    })
    ...
    function submit(){
        ...
        //     },
        // })
        console.log(form.handledBarangays)
    }
</script>
...
<template>
    <main class="w-full h-full flex flex-col justify-start items-start gap-4 p-2">
        ...
        <section class="w-full flex flex-col gap-3 border-b">
            <span class="text-lg font-bold uppercase tracking-tight text-stone-900">Edit User</span>
        </section>
        ...
        <section class="w-full flex flex-col justify-start items-start gap-6">
            <div class="w-full flex flex-col justify-start items-start outline outline-gray-400 shadow-md divide-y">
                <div class="w-full flex bg-[#3F4E2E] text-white p-2">
                    <span class="font-semibold uppercase">User Assigned Barangays</span>
                </div>

                <div class="w-full flex flex-col justify-start items-start gap-4 p-4">
                    <multiselect 
                        v-model="form.handledBarangays" 
                    ...
                    ></multiselect>
                    <span v-if="form.errors.handledBarangays" class="text-xs text-red-500">{{ form.errors.handledBarangays }}</span>
                </div>
